...
| --------------------------------------- | ----------------------------------------- | ------------------------------------- | --------------------------------------- | ------------------------------------------ | ----------------------------------------- | -------------------------------------- | ----------- | ----------- |
| [Office 操作](./notes/01-Office操作.md) | [Windows 操作](./notes/02-Windows操作.md) | [MacOS 操作](./notes/03-MacOS操作.md) | [Chrome 操作](./notes/04-Chrome操作.md) | [Android/iOS 操作](./notes/05-手机操作.md) | [操作系统安装教程](./notes/os-install.md) | [技能大杂烩](./notes/06-技能大杂烩.md) | 其他        | 其他        |
