...
- [Zotero](https://www.zotero.org/download/)
  ...
  >
  > - 要是在安装完 Zotero 后，未自动安装对应的 Word 插件，可以尝试该方式：[zotero自动安装word插件失败](<https://blog.csdn.net/weixin_41950276/article/details/89099788>)，亲测可解决问题。
  >
...
- Microsoft Office
  ...
  >
  > ①**Office 2013** 建议安装：`Office Professional Plus 2013 VOL (x64) - (Chinese-Simplified) `，下载链接：
  >
  > ``` xml
  ...
  >
  > ②**Office 2016**：本人有在网上找到一个 Office 2016 专业增强版，安装完打开显示：
  >
  > ``` xml
  > 激活的产品
...
- Microsoft Visio
  ...
  >
  > ①**Visio 2013** 建议安装：`SW_DVD5_Visio_Pro_2013w_SP1_64Bit_ChnSimp_MLF_X19-36392.iso`，貌似在MSDN我要告诉你网站找不到，那就找网上找下吧。（**激活：可以 KMSpico 或 Microsoft Toolkit 工具激活，应该都是 180 天到期。软件可以在本页面找到。**）
  >
  > ②Visio 2016 建议安装：建议下载以 SW_ 开头为名称的安装包，这种大概率是 VOL 版。然后激活方式类似。这里找到一个 `SW_DVD5_Visio_Pro_2016_64Bit_ChnSimp_MLF_X20-42759.ISO`，下载地址是：
  >
  > ``` xml
